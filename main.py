...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_dir", default="./PhoATIS", type=str, help="The input data dir"
    )
    parser.add_argument(
        "--intent_label_file",
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="Concatenate n_hiddens final layer of [CLS] token's representation.",
    )
    parser.add_argument(
        "--learning_rate",
        default=5e-5,
    ...
    parser.add_argument(
        "--do_eval_dev", action="store_true", help="Whether to run eval on the dev set."
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.5,
        help="Coefficient for the intent loss.",
    )
